...
CREATE TABLE `insurance_data` (
  ...
  `msp_category` int(11) DEFAULT NULL COMMENT 'references option_id in MSP_Categories list',
  PRIMARY KEY  (`id`),
...
CREATE TABLE ar_activity (
  ...
  ded_amount     DECIMAL(12,2) DEFAULT '0.00',
  modified_time datetime NOT NULL,
  ...
  rsn_code      VARCHAR(10) DEFAULT NULL,
  ins_adjud_date DATE,
