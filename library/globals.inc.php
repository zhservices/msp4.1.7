...
$GLOBALS_METADATA = array(
  ...
  'Features' => array(
    ...
    'msp_capturing_payment_screen' => array(
      xl('MSP Capturing In Payment Screen'),
      'bool',                           // data type
      '0',                              // default = true
      xl('This will use to enable MSP capturing in payment screen.')
    ),
