          ...
          if ($INTEGRATED_AR) {
            ...
            foreach ($svc['adj'] as $adj) {
                ...
                if ($adj['group_code'] == 'PR' || !$primary) {
					...
					//instead of zero adjustment as above mentioned capturing the amount and saving it in the deductible column
					//eldho zh for medicare secondary 11/01/2011
            ...
            ****/
            ...
            if ($INTEGRATED_AR) {
              arPostAdjustment($pid, $encounter, $InsertionId[$out['check_number']], 0, $codekey,//$InsertionId[$out['check_number']] gives the session id
                substr($inslabel,3), $reason, $debug,$deductible,$grpcode,$reasoncode);
				//after debug 3 more parameres added ZH (deductible amount,grpcode,reasoncode
				//this is for handling Medicare Secondary 11.01.2011 Eldho.
            } else {
            ...
            if ($INTEGRATED_AR) {
              arPostAdjustment($pid, $encounter, $InsertionId[$out['check_number']], $adj['amount'],//$InsertionId[$out['check_number']] gives the session id
                ...
                "Adjust code " . $adj['reason_code'], $debug,$deductible,$grpcode,$reasoncode);
				//after debug 3 more parameres added ZH (deductible amount,grpcode,reasoncode
				//this is for handling Medicare Secondary 11.01.2011 Eldho.
            } else {
