...
//===============================================================================
?>
<table width="1034" border="0" cellspacing="0" cellpadding="0"  id="TablePatientPortion">
	  <tr height="5">
		<td colspan="14" align="left" >
			<table width="1034" border="0" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
			  <tr height="5">
				<td class='title' width="1034" ></td>
			  </tr>
			  <tr>
				<td  class='text'><table width="1034" border="0" cellspacing="0" cellpadding="0" style="border:1px solid black" >
			  <tr>
				...
				<td width="80" class="text">&nbsp;<input type="radio" name="RadioPaid" onClick="SearchOnceMore()" <?php echo $_REQUEST['RadioPaid']=='Non_Paid' 
	...
	<td colspan="13" align="left" >
			...
			if($RowSearch = sqlFetchArray($ResultSearchNew))
			 {
			?>
			<table width="1034"  border="0" cellpadding="0" cellspacing="0" align="center" id="TableDistributePortion">
			  ...
			  <tr class="text"  bgcolor='<?php echo $bgcolor; ?>' id="trCharges<?php echo $CountIndex; ?>">
				...
				if($GLOBALS['msp_capturing_payment_screen']){
				?>
				<td class="<?php echo $StringClass; ?> right" onclick="add_dynamic_row('<?php echo $CountIndex; ?>','<?php echo $CountIndexAbove*1+1; ?>','<?php echo $TotalRows; ?>');" ><img src="../pic/add_btn.png" border="0"</td>
				<?php
				}
				?>
			  </tr>
